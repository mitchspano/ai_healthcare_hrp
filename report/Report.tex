...
% --- Remove copyright/permission block ---
\settopmatter{printacmref=true} % enables ACM reference format as required
\renewcommand\footnotetextcopyrightpermission[1]{} % suppresses the permission text
\pagestyle{plain} % optional: removes running headers

% --- Clear metadata so nothing extra prints ---
\acmConference[]{}{}{}
\acmBooktitle{}
\acmPrice{}
\acmDOI{}
...
% Ensure all citations are present in references.bib and used with \cite{}
% Example:
% \cite{Georga2013}
% \cite{Zhu2019}
% \cite{Cameron2018}
